...
class Model(Container):
    ...
    def _standardize_user_data(self, x, y,
        ...
        # w = [1, 1, 1, 1, 3]
        # sample_weight = np.tile(w, (sample_weight['word_qe'].shape[0], sample_weight['word_qe'].shape[1], 1))

        # for i in range(len(y)):
        #     for j in range(y[i].shape[0]):
        #         y_new  = y[i][j]
        #         for h in range(y_new.shape[0]):
        #             if y_new[h][4] == 1:
        #                 dict = sample_weight['word_qe'][j]
        #                 dict[h] = 3
    ...
    def predict_generator(self, generator, steps,
        ...
        if len(all_outs) == 1:
            if steps_done == 1:
                ...
                #return np.concatenate(all_outs[0], axis=1)
