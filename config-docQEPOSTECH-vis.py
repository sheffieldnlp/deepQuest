def load_parameters():
    ...
    PRED_VOCAB = 'Dataset_wmt18-en-fr-predictor_enfr.pkl' #'vocabs-coling/Dataset_predictor-en-es-euro-newscom-small_enes.pkl'
    PRED_WEIGHTS = 'epoch_4_weights.h5' #'weights_en-es-coling/epoch_2_weights.h5'
    MULTI_TASK = False
    ...
    # Model parameters
    # Perictor+Estimator
    MODEL_TYPE = 'EstimatorDocVis'                 # Model to train. See model_zoo() for the supported architectures
