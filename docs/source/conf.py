...
htmlhelp_basename = 'DeepQuestdoc'
...
latex_documents = [
    (master_doc, 'DeepQuest.tex', 'DeepQuest Documentation',
     'Julia Ive, Fred Blain, Lucia Specia', 'manual'),
]
...
man_pages = [
    (master_doc, 'deepquest', 'DeepQuest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DeepQuest', 'DeepQuest Documentation',
     author, 'DeepQuest', 'One line description of project.',
     'Miscellaneous'),
]
