def load_parameters():
    ...
    OUTPUTS_IDS_DATASET_FULL = ['word_qe', 'sent_qe']                   # Corresponding outputs of the dataset
    ...
    OUTPUTS_IDS_MODEL_FULL = ['word_qe', 'sent_qe']                     # Corresponding outputs of the built model
    ...
    PRED_WEIGHTS='euro-en-de-model-latest/epoch_4_weights.h5'
    #PRED_WEIGHTS='/home/julia/postech-qe-reproduced/postech/nmt-keras/trained_models/Predictor/epoch_5_weights.h5'
    MULTI_TASK = True
    ...
    EPOCH_PER_UPDATE = 1
    EPOCH_PER_PRED = 10
    EPOCH_PER_EST_SENT = 5
    EPOCH_PER_EST_WORD = 5
    ...
    # Model parameters
    # Perictor+Estimator
    MODEL_TYPE = 'Estimator'                 # Model to train. See model_zoo() for the supported architectures
