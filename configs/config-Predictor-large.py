def load_parameters():
    ...
    # Input data params
    TASK_NAME = 'wmt-17-en-de-data'                           # Task name
    ...
    #PRED_VOCAB = '/home/julia/postech-qe-reproduced/Dataset_to_nmt_en-de_ende.pkl'
    ...
    INPUT_VOCABULARY_SIZE = 70000                     # Size of the input vocabulary. Set to 0 for using all,
    ...
    OUTPUT_VOCABULARY_SIZE = 70000                    # Size of the input vocabulary. Set to 0 for using all,
                                                  # otherwise it will be truncated to these most frequent words.
    ...
    # Model parameters
    # Perictor+Estimator
    MODEL_TYPE = 'Predictor'                 # Model to train. See model_zoo() for the supported architectures
    ...
    SOURCE_TEXT_EMBEDDING_SIZE = 500              # Source language word embedding size.
    ...
    TARGET_TEXT_EMBEDDING_SIZE = 500               # Source language word embedding size.
    ...
    ENCODER_HIDDEN_SIZE = 700                      # For models with RNN encoder
    ...
    DECODER_HIDDEN_SIZE = 700                      # For models with RNN decoder
