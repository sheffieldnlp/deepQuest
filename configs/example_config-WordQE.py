def load_parameters():
    ...
    PRED_VOCAB = '/path/to/my/dataset.pkl'
    PRED_WEIGHTS='/path/to/my/weights.h5'
    MULTI_TASK = False
    ...
    # Model parameters
    # e.g. Perictor+Estimator
    MODEL_TYPE = 'EstimatorWord'                  # Model to train. See model_zoo() for the supported architectures
    # e.g. Predictor only
